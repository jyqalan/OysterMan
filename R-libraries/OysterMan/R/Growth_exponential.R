setGeneric("Growth_exponential", function(object, ...)standardGeneric("Growth_exponential"))

setClass("Growth_exponential",representation("Growth",l1="numeric",l2="numeric",g1="numeric",g2="numeric",alpha="numeric",beta="numeric",minsigma="numeric",delta="numeric"))

setMethod("initialize", signature(.Object="Growth_exponential"),
...
setMethod("Growth_exponential", signature(object="missing"),
	function(object,n_classes,class_mins,plus_group,plus_group_size,l1,l2,g1,g2,alpha,beta,minsigma=0,delta=1){
            return(new("Growth_exponential",n_classes=n_classes,
...
setMethod("get_mu", signature(object="Growth_exponential"),
	function(object,l) {
            mu<-posfun(object@delta*object@g1*(object@g2/object@g1)^((l-object@l1)/(object@l2-object@l1)))
             return (mu)
 	}
)

setMethod("get_stdev", signature(object="Growth_exponential"),
	function(object,l) {
            mu = get_mu(object,l)
